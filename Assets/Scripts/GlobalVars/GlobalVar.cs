...
[CreateAssetMenu(fileName = "New Global Variable", menuName = "Global Variables")]
public class GlobalVar<T> : ScriptableObject
{
    ...
    /// </summary>
    [Tooltip("Should a stack trace be continually built for this variable as it's being saved/loaded/accessed/changed?")]
